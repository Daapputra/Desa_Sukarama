...
import { adminUsers, pengumuman, suratPengajuan, umkmProduk, pesanKontak, } from '../db/schema.js';
import { hashPassword, generateToken, setToken, getToken, deleteToken, } from '../plugins/auth.js';
...
export async function adminRoutes(fastify) {
    ...
    fastify.get('/api/admin/stats', { preHandler: requireAuth }, async () => {
        const [[suratBaru], [suratProses], [suratSelesai], [totalSurat], [totalUmkm], [totalPengumuman], [pesanBaru],] = await Promise.all([
